...
public class BasicsLesson {
    ...
    public String littleKid(String word) {
        String result = null;
        result = word.replace('Р', 'Л').replace('р', 'л');
        return result;
    }
     ...
     */
    public LethalWeapon newClass() {
        LethalWeapon o = null;
        o = new LethalWeapon("белый", 100.5, 7);
        return o;
    }
    ...
    public String stringExercise1(String input) {
        String result = null;
        result = input.substring(2,input.indexOf('S')+1).toUpperCase();
        return result;
    }
    ...
    public int stringExercise2(String input) {
        ...
        int countComma = 0, countHyphen = 0, countBlank = 0;
        ...
        int result = input.length()*countComma*countHyphen*input.indexOf('R')*input.lastIndexOf('L')*countBlank;
        return result;
    }
        ...
        if (strArray.length == 3) {
            for (int i=0; i<strArray.length; i++) {
                if (strArray[i].equals("Hello")) {
                    input = strArray[0] + " " + strArray[2];
                    break;
                }
                if (strArray[i].equals("Goodbye")) {
                    input = strArray[0] + " " + strArray[2];
                    if (input.endsWith("!")) {
            ...
            for (int i=0; i<strArray.length; i++) {
                if (strArray[i].equals("Hello")) {
                    ...
                    for (int j=0; j<chArray.length; j++) {
                        result = chArray[j] + result;
                    }
                    input = result;
                    break;
                }
                if (strArray[i].equals("Goodbye")) {
                    input = strArray[1] + " " + strArray[0];
